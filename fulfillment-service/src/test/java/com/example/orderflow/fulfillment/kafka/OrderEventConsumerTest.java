...
class OrderEventConsumerTest {
    ...
    @BeforeEach
    void setUp() {
        consumer = new OrderEventConsumer(fulfillmentService, eventPublisher, objectMapper);
    ...
    @Test
    @DisplayName("should delegate to FulfillmentService on consume")
    ...
    @Test
    @DisplayName("should propagate exception from FulfillmentService for retry")
